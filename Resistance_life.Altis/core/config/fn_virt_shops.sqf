...
switch (_shop) do
{
	...
	case "rebel": {["Marché Rebelle",["water","rabbit","redgull","tbacon","lockpick","pickaxe","fuelF","boltcutter","blastingcharge","figue","olive","raisin","jusraisin"]]};
	case "gang": {["Marché de Gang", ["water","rabbit","redgull","tbacon","lockpick","pickaxe","fuelF","blastingcharge","boltcutter","figue","olive","raisin","jusraisin"]]};
	...
	case "cop": {["Marché Policier",["donuts","coffee","spikeStrip","water","rabbit","redgull","fuelF","defusekit","barricade","barrier"]]};
