...
switch (_filter) do
{
	...
	case 0:
	{
		[
            ...
            ["U_Marshal","Costard TransAltis",5000],
            ["U_C_Squelette_Noir","Squelette",5000],
	...
	case 1:
	{
		[
			...
			["H_Cap_red",nil,170],
			["H_Cap_tan",nil,150],
			["Kio_Afro_Hat",nil,2000],
            ["Kio_Capital_Hat",nil,2000]
		];
	};
