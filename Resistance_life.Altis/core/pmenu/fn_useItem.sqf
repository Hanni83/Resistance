...
switch (true) do
{
	...
	case (_item in ["rabbit","salema","ornate","mackerel","tuna","mullet","catshark","turtle","turtlesoup","donuts","tbacon","figue","olive","raisin"]):
	{
	...
	case (_item == "mdma" or _item == "mescaline"):
	{
		if(([false,_item,1] call life_fnc_handleInv)) then
		{
			[] spawn life_fnc_LSD;
