/*
	...
	Description:
	Erméglicht senden bzw. die Abfrage des Geschriebenen.
...
//[[4,format ["%1 a envoyer un message a Channel7 pour tout le monde: %2",name player,_message]],"life_fnc_broadcast",true,false] call life_fnc_MP;
[[4,format ["%1 a envoyer un message a Channel7 pour tout le monde: %2",player getVariable["realname",name player],_message]],"life_fnc_broadcast",civilian,false] call life_fnc_MP;
