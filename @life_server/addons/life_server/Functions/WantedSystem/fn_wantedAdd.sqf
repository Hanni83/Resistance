...
switch(_type) do
{
    case "187V": {_type = ["Homicide involontaire (véhicule)",17000]};
    case "187": {_type = ["Homicide involontaire",15000]};
    case "901": {_type = ["Evasion de Prison",55000]};
    case "261": {_type = ["Viol",5000]};
    case "261A": {_type = ["Tentative de viol",3000]};
    case "215": {_type = ["Tentative de Car-Jacking",5000]};
    case "213": {_type = ["Utilisation d'explosifs illégaux",100000]};
	case "211A": {_type = ["Tentative de Vol",2500]};
    case "211": {_type = ["Vol",5000]};
    ...
    case "480": {_type = ["Délit de fuite",13000]};
    case "481": {_type = ["Possession de drogue",20000]};
    case "482": {_type = ["Deal",50000]};
    case "483": {_type = ["Traffic de drogue",50000]};
    case "503": {_type = ["Commerce des marchandises exotiques",25000]};
	...
	case "25": {_type = ["Port d'arme illégale",10000]};
